<template>
    <div class="page-content ">
                ...
                <div class="title_content">
                    <div  class="feature_icon bg--profilet">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                width="25px" viewBox="0 0 434.168 434.168" style="enable-background:new 0 0 434.168 434.168;" xml:space="preserve">
        ...
        <b-container class="m-t-30">
            <p>
                These terms and conditions (&quot;Terms&quot;, &quot;Agreement&quot;) are an agreement between
                Website Operator (&quot;Website Operator&quot;, &quot;us&quot;, &quot;we&quot; or &quot;our&quot;) and you (&quot;User&quot;, &quot;you&quot; or
                &quot;your&quot;). This Agreement sets forth the general terms and conditions of your use of
                the hr-bee.com website and any of its products or services (collectively, &quot;Website&quot; or
                &quot;Services&quot;).
            
            </p>

            <h3 class="m-b-20">Accounts and membership</h3>
            <p>
            ...
            <h3 class="m-b-20">User content</h3>
            <p>
            ...
            <h3 class="m-b-20">Links to other websites</h3>
            <p>
            ...
            <h3 class="m-b-20">Prohibited uses</h3>
            <p>
            ...
            <h3 class="m-b-20">Intellectual property rights</h3>
            <p>
            ...
            <h3 class="m-b-20">Limitation of liability</h3>
            <p>
            ...
            <h3 class="m-b-20">Indemnification</h3>
            <p>
            ...
            <h3 class="m-b-20">Severability</h3>
            <p>
            ...
            <h3 class="m-b-20">Dispute resolution</h3>
            <p>
                   The formation, interpretation, and performance of this Agreement and any disputes arising out of it shall be governed by the substantive and procedural laws of Tirana, Albania without regard to its rules on conflicts or choice of law and, to the extent applicable, the laws of Albania. The exclusive jurisdiction and venue for actions related to the subject matter hereof shall be the state and federal courts located in Tirana, Albania, and you hereby submit to the personal jurisdiction of such courts. You hereby waive any right to a jury trial in any proceeding arising out of or related to this Agreement. The United Nations Convention on Contracts for the International Sale of Goods does not apply to this Agreement.

            </p>

             <h3 class="m-b-20">Changes and amendments</h3>
            <p>
             ...
             <h3 class="m-b-20">Acceptance of these terms</h3>
            <p>
...
export default {
  ...
  metaInfo: {
      ...
      meta: [ { name: 'description', content: 'These terms and conditions ("Terms", "Agreement") are an agreement between Website Operator ("Website Operator", "us", "we" or "our") and you ("User", "you" or "your"). ' }],
  },
  mounted() {
