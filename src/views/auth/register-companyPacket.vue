<template>
    <div class="page_content container infoPage">
        ...
        <b-row>
            <b-container class="registerPage">
                ...
                <b-container class="changeRegister text-center">
                    <router-link :to="'/auth/company'" class="registerButton activeRegisterButton">COMPANY</router-link>
                    <router-link :to="'/auth/jobseeker'" class="registerButton">JOB SEEKER</router-link>
                </b-container>
            </b-container>
        </b-row>
            ...
            this.$validator.validate().then((valid) => {
                if (valid) {
                    let submitted_user_data = {
                        ...
                        user_type: 'company',
                        packet: this.$route.params.packet,
