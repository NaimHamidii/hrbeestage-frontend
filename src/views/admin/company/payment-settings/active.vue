    ...
    <div class="page_content">
        <div class="boxi">
            ...
            <template v-if="get_company_purchased_packages.length > 0 " >
                <div class="textinBox">
                    <h4>{{$t('payment_settings.activemodules')}}</h4>
                    <p>{{$t('payment_settings.activemodulesdsc')}}</p>
                </div>
                <hr>
                <div class="row">
                    <div class="col-md-6" v-for="package_item in get_company_purchased_packages" :key="package_item.company_packages_id">
                        <div class="moduleBox">
                            <div class="row">
                                <div class="col-4">
            ...
            <template v-else>
                <div class="textinBox text-center">
                    <h4>{{$t('payment_settings.noactivemodules')}}</h4>
                </div>
            </template>
        </div>
    </div>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                purchased_packages_loading: false,
                tabIndex: 0,
        ...
        created(){
            ...
            this.get_all_company_purchased_packages()
        },
