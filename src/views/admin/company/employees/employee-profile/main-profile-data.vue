        ...
        <template v-else>
            <form class="form-type-1 add_employee_form" @submit.prevent="updateEmployeeProfileData">
                ...
                <div class="box m-b-20">
                    <p>Email below is employees main account. Basically {{ name }} {{ surname }} can login to their employee dashboard via this email.</p>
                    <div class="form__group">
                        <label for="email" class="form__label bold">{{ $t('inputs.email') }}<span class="required">(*)</span></label>
                        <input disabled v-validate="'required'" maxlength="255" class="form__input" id="email" type="email" :placeholder="$t('inputs.email')" v-model="email" name="email" />
                        <span v-if="submitted && errors.has('email')" class="form-error-notification error">
                            {{ $t('inputError.required') }}
                        </span>
                    </div>
                    <div class="">
                        <label class="form__label bold">Generated password:</label>

                        <div class="chip bg--text-red-contrast m-b-10 m-t-10">
                            <p>
                ...
                <div class="box">
                    <div class="form__inline">
                        ...
                        <div class="form__group">
                            ...
                            <input v-validate="'digits:16'" class="form__input" id="employee_bank_account_number" maxlength="16" type="text" placeholder="1892381928312983123" v-model="employee_bank_account_number" name="employee_bank_account_number" />
                ...
                <div class="box">
                    <div class="form__inline">
                        ...
                        <div class="form__group">
                            ...
                            <input v-validate="'digits:13'" maxlength="16" class="form__input" id="contact_person_phone" type="text" placeholder="00383" v-model="contact_person_phone" name="contact_person_phone" />
                            <span v-if="submitted && errors.has('contact_person_phone')" class="form-error-notification error"> E.x. 0038343715716 - 13 numbers are required </span>
                        </div>
                    </div>
                    <div class="form__group">
