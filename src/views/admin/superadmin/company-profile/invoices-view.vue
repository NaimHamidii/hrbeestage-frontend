        ...
        <template v-else>
                    ...
                    <div id="page_title" class="page_title has-back-arrow has-menu-right m-b-30">
                        ...
                        <div class="hrbee-widget-icon  m-t-20 m-b-50  inline">
                            <router-link :to="'/app/company/profile/'+current_company_id+'/invoices'">
                                    <div class="icon bg--hyrjet">
                                        <i class="hr-icon-md-arrow-back"></i>
                                    </div>
                               </router-link>
                            <div class="title">
                                    <h5>Go back to invoices</h5>
                            </div>
                        </div>
                    ...
                    <div class="invoice_template_v1">
                            <b-row class="invoice_row">
                                <b-col md="4">
                                    <img class="invoice_logo" src="/images/logo-color.svg" >
                                </b-col>
    ...
    export default {
        ...
        computed:{
            current_invoice_details(){
                return this.$store.getters['superadmin/payments/get_current_invoice']
            },
            company_data : function() {
                return this.$store.getters['superadmin/companies/get_company_profile']
            },
        ...
        created(){
            ...
            if( this.$route.params.id !== undefined  ){
                 current_company_id = parseInt(this.$route.query.c_id)
                 current_invoice_id = parseInt(this.$route.query.i_id)
                 ...
                 setTimeout(() => {
                    this.$store.dispatch("superadmin/payments/get_invoice_details", data)
                    this.$store.dispatch("superadmin/companies/get_company_profile_data" ,  this.current_company_id)
                    .then(response => {
                            this.component_loading = false    
                            
                            //this.current_company_id = response.data.company_id           
                    })
