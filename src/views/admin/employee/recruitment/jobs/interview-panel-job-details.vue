                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <div class="textinBoxCandidateDetails">
                                            ...
                                            <template v-else-if="candidate_item.is_blacklisted">
...
import userResume from '@employee_components/jobs/interview-panel-candidate-resume'
...
export default {
    ...
    computed: {
        job_candidates: function () {
            return this.$store.getters['employee_data/interviewPanelJobApplications/get']
        },
    },
    watch: {
        experiences() {
    ...
    methods: {
        ...
        getCandidatesWithFilter: function (filter_degree, filter_by_gender, filter_by_skills, filter_by_language, field_of_study, filter_profession, filter_years_in_profession, filter_by_cover_letter, filter_by_reference, filter_application_status, filter_rating_applied) {
            ...
            setTimeout(() => {
                this.$store.dispatch('employee_data/interviewPanelJobApplications/filter_candidates', filter_data).then((response) => {
        ...
        getAllCandidates: function () {
            ...
            setTimeout(() => {
                this.$store.dispatch('employee_data/interviewPanelJobs/get_single_job', this.current_created_job_id).then((response) => {
                    this.current_job_details = response.data[0]
                })
                this.$store.dispatch('employee_data/interviewPanelJobApplications/get_single_job_applications', this.current_created_job_id).then((response) => {
        ...
        deleteFilters: function () {
            ...
            setTimeout(() => {
                this.$store.dispatch('employee_data/interviewPanelJobApplications/get_single_job_applications', this.current_created_job_id).then(() => {
                    this.search_active = false
                })
            }, 200)
        },
        ...
        loadAnotherPage: function (page_number_to) {
            ...
            if (this.searchByName) {
                alert('work')
                setTimeout(() => {
                    this.$store.dispatch('employee_data/interviewPanelJobApplications/search_single_job_application_with_page', querywithpage).then((response) => {
                        this.component_loading = false
                    })
                }, 200)
            } else {
                setTimeout(() => {
                    this.$store.dispatch('employee_data/interviewPanelJobApplications/get_single_job_applications_with_pagination', query).then((response) => {
                        this.component_loading = false
                    })
                }, 200)
            }
        ...
        searchCandidates: function (query) {
            ...
            setTimeout(() => {
                this.$store.dispatch('employee_data/interviewPanelJobApplications/search_job_application', SearchData).then((response) => {
                    this.search_active = false
                })
            }, 200)
        },
        ...
        reset_search: function () {
            ...
            this.search_active = true
            setTimeout(() => {
                this.$store.dispatch('employee_data/interviewPanelJobApplications/get_job_applications', this.current_created_job_id).then(() => {
                    this.search_active = false
                })
            }, 200)
        },
