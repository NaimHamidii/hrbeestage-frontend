    ...
    export default {
        ...
        computed: {
            ...
            all_dress_codes : function() {                             
                if(this.$store.getters['employee_data/companysettings/get']){
                    return this.$store.getters['employee_data/companysettings/get']
                }                
            }
        },
        ...
        methods: {
            ...
            get_company_departments: function(){
                setTimeout(() => {
                    this.$store.dispatch("employee_data/companysettings/get_company_departments")
                        .then(response => {  
            ...
            onDepartmentSelect(data){
                ...
                setTimeout(() => {
                    this.$store.dispatch("employee_data/companysettings/get_positions_by_department", submitdata)
                        .then(response => {
            ...
            filter_dress_codes(){
                ...
                setTimeout(() => {
                    this.$store.dispatch("employee_data/companysettings/show_dress_codes", dress_data)
                    .then(response => {
