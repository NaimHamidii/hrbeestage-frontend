<template>
    <div class="page_content">
        <!-- EDITOR -->
        <div class="feed_header box" v-if="current_user_can_make_social_posts">
...
export default {
    ...
    data() {
        return {
            ...
            current_user_can_make_social_posts: false,
    ...
    created() {
        ...
        if (current_role == 'employee') {
            this.$store.dispatch('auth/get_loggedin_user_data', true).then(() => {
                ...
                this.current_user_can_make_social_posts = localStorage.getItem('auth_canMakeSocialPosts') == 1
            })
        } else if (current_role == 'company') {
