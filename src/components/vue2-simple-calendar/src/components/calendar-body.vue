    ...
    <div class="calendar-body">
        ...
        <div class="days-body">
            <div class="week-row" v-for="(week, key) in calendar" :key="key">
                <div :key="key" class="week-day" :class="dayClasses(day)" v-for="(day, key) in week" @click.stop="dayClicked(day)">
                    <div class="day-number">
                        {{ day.monthDay }}
                    </div>

                    <events-box v-if="(dayEvents = getEventsForDay(day.date))" :events="dayEvents" :display-show-more-count="displayShowMoreCount"></events-box>
                </div>
            </div>
        </div>
    </div>
